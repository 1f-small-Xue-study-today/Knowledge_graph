...
\section{Other Related Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Independent Thesis Project}{waittofill Location}
      \resumeItemListStart
...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {BEng in Mechanical Engineering}{2021.09 -- 2022.05}
    \resumeSubheading
...
\section{Additional Information}
  \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
      \textbf{Languages}{: Fluent English speaking; able to work fully in an English-speaking engineering environment.} \\
      \textbf{Hiring Support}{: Supported part-time technical hiring by sourcing and evaluating high-qualified candidates for the engineering group using personal connections.} \\
      \textbf{Personal}{: Keep a dog and a cat.}
    }}
 \end{itemize}
