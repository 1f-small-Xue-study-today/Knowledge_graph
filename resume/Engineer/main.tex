...
\small{Automation Engineer - Robotics and AI/ML}

%-----------PROFESSIONAL SUMMARY-----------
\section{Professional Summary}
\small{
Robotics and control engineer focused on gimbal control, embedded motor validation, and hardware-software integration. Experienced in system-identification-based motor testing, MCU-deployable ML diagnostics, reliability standards, and automated validation workflows using Python, C++, MATLAB/Simulink, GDB-JLink, UART, and lab instrumentation. Research background spans mobile robot arm planning, collision avoidance, tailsitter UAV control
}
